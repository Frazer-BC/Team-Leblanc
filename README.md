...
-   [Vecteezy](https://vecteezy.com) and [Microsoft Design](https://create.microsoft.com/en-us/features/ai-image-generator) were used to generate the images with detailed AI prompts.
-   [Canva](https://canva.com/en_gb/) was used for resizing and editing images for the website.
...
![contact-page-bug](/assets/documentation/bug1.png)
...
![contact-page-layout](/assets/documentation/bug2.png)
...
* Live link to the live website can be found [Here](https://frazer-bc.github.io/Team-Leblanc/).
...
* Basic HTML structure inspired from Love Running project.

* Code for media query was set using informations provided by ChatGPT.

* Keyframes animation code based on informations on [W3Schools](https://www.w3schools.com/css/css3_animations.asp).
...
* The colour pallet was based on a palette generator [from Coolors.co](https://coolors.co/)

* The icons in the header, footer and reviews section were taken from [Font Awesome](https://fontawesome.com/)

* The fonts used were imported from [Google Fonts](https://fonts.google.com/)

* Gallery images generated by A.I and taken from [Microsoft Designer](https://create.microsoft.com/en-us/features/ai-image-generator)

* Image of New Orleans behind the artist on the About page came from [Canva](https://canva.com/en_gb/)

### Additional content

* Chat GPT used for generating the fictional reviews and improving on the Biography.
