...
* The colour pallet were based on a palette generator [from Coolors.co](https://coolors.co/)

* The icons in the header, footer and reviews section were taken from [Font Awesome](https://fontawesome.com/)

* The fonts used were imported from [Google Fonts](https://fonts.google.com/)

* Gallery images was generated by A.I and was taken from Microsoft Design.
